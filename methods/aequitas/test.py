from methods.aequitas.algo import run_aequitas, run_aequitas2
...
results_df_origin, metrics = run_aequitas2(discrimination_data=data_obj,
...
results_df_synth, metrics_synth = run_aequitas2(discrimination_data=data_obj_synth,
                                               model_type='rf', max_global=100,
                                               max_local=1000, step_size=1.0, random_seed=42,
                                                max_tsn=4000, one_attr_at_a_time=True)
