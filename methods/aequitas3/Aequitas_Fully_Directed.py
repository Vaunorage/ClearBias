...
parser.add_argument('--classifier_name', type=str, required=False,
                   help='Name of the classifier file (e.g., Random_Forest_standard_unfair.pkl)',
                    default='Random_Forest_standard_unfair.pkl')
...
print("Percentage discriminatory inputs - {:.2f}%".format((len(global_disc_inputs_list) + len(local_disc_inputs_list)) / len(tot_inputs) * 100))
print("")
...
print("")
print("Total Inputs are {}".format(len(tot_inputs)))
print("Number of discriminatory inputs are {}".format(len(global_disc_inputs_list) + len(local_disc_inputs_list)))
print("Time running : {:.2f} seconds".format(time.time() - start_time))