...
data_obj_synth, schema = generate_from_real_data('adult', predefined_groups=predefined_groups_origin,
                                                 additional_random_rows=sum([el for el in predefined_groups_origin]))
...
#%% Run fairness testing
results_df_synth, metrics_synth = adf_fairness_testing(data_obj_synth, max_global=5000, max_local=2000, max_iter=25,
                                                       cluster_num=50, random_seed=42)
