...
from experiments.synthetic_datasets_experiments.analysis import analyze_matching_synthetic_and_result
...
if __name__ == "__main__":
    ...
    data_configs = [
        ...
        {'nb_groups': 30, 'nb_attributes': 20, 'prop_protected_attr': 0.1, 'min_number_of_classes': 8,
         ...
         'min_similarity': 0.4},
        # Super large number of groups
        {
            'nb_groups': 100,  # Extreme value - 100 groups
            'nb_attributes': 5,
            ...
            'use_cache': True,
            'min_group_size': 50,
            'max_group_size': 200,  # Smaller group size to balance total dataset size
            'min_similarity': 0.5
        },
        ...
        # Ultra-small groups
        {
            ...
            'max_number_of_classes': 4,
            'use_cache': True,
            'min_group_size': 10,  # Extremely small groups
            'max_group_size': 50,
            'min_similarity': 0.5
        },
        ...
        # Very large groups
        {
            ...
            'max_number_of_classes': 4,
            'use_cache': True,
            'min_group_size': 1000,  # Very large minimum
            'max_group_size': 10000,  # Extremely large maximum
            'min_similarity': 0.5
        },
        ...
        {
            'nb_groups': 10,
            'nb_attributes': 30,  # Extreme number of attributes
            'prop_protected_attr': 0.2,
            'min_number_of_classes': 2,
            'max_number_of_classes': 4,
            'use_cache': True,
        ...
        # Many classes per attribute
        {
            'nb_groups': 10,
            'nb_attributes': 5,
            'prop_protected_attr': 0.2,
            'min_number_of_classes': 10,  # Many classes minimum
            'max_number_of_classes': 20,  # Extreme number of classes maximum
            'use_cache': True,
            'min_group_size': 200,  # Larger groups to ensure enough samples per class
            'max_group_size': 2000,
            'min_similarity': 0.5
        },

        # Extremely low similarity value
        {
            'nb_groups': 10,
            'nb_attributes': 5,
            'prop_protected_attr': 0.2,
            ...
            'min_group_size': 100,
            'max_group_size': 1000,
            'min_similarity': 0.05  # Extremely low similarity
        },

        # Extremely high similarity value
        {
            'nb_groups': 10,
            'nb_attributes': 5,
            'prop_protected_attr': 0.2,
            ...
            'min_group_size': 100,
            'max_group_size': 1000,
            'min_similarity': 0.99  # Nearly identical groups
        },

        # Mix of extremes - Large dataset with everything pushed to extremes
        {
            'nb_groups': 50,
            'nb_attributes': 25,
            'prop_protected_attr': 0.6,  # High protected attribute proportion
        ...
        # Minimal configuration - testing lower bounds
        {
            'nb_groups': 1,  # Single group
            'nb_attributes': 1,  # Single attribute
            'prop_protected_attr': 1.0,  # All attributes are protected
            'min_number_of_classes': 2,
            'max_number_of_classes': 2,
            'use_cache': True,
            'min_group_size': 50,
            'max_group_size': 100,
            'min_similarity': 1.0  # Perfect similarity
        },

        # Highly imbalanced group sizes
        {
            'nb_groups': 10,
            'nb_attributes': 5,
            'prop_protected_attr': 0.2,
            ...
            'max_number_of_classes': 4,
            'use_cache': True,
            'min_group_size': 10,  # Very small minimum
            'max_group_size': 20000,  # Very large maximum - creates highly imbalanced groups
            'min_similarity': 0.5
        },

        # Extreme proportion of protected attributes
        {
            'nb_groups': 10,
            'nb_attributes': 15,
            'prop_protected_attr': 1.0,  # All attributes are protected
        ...
        # Small groups with many attributes and classes - challenging case
        {
            'nb_groups': 30,
            'nb_attributes': 20,
            'prop_protected_attr': 0.4,
            'min_number_of_classes': 8,
            'max_number_of_classes': 12,
            'use_cache': True,
            'min_group_size': 20,  # Very small groups
            'max_group_size': 100,
            'min_similarity': 0.2  # Low similarity
        },

        # Extreme case - many groups, many attributes, many classes, zero similarity
        {
            'nb_groups': 50,
            'nb_attributes': 30,
            'prop_protected_attr': 0.3,
            'min_number_of_classes': 15,
            'max_number_of_classes': 25,
            'use_cache': True,
            'min_group_size': 50,
            'max_group_size': 500,
            'min_similarity': 0.01  # Almost no similarity between groups
        }
    ]
