...
results_df_origin, metrics_origin = run_adf(data_obj, max_global=20000, max_local=100, cluster_num=50,
...
results_df_synth, metrics_synth = run_adf(data_obj_synth, max_global=20000, max_local=100, cluster_num=50,
